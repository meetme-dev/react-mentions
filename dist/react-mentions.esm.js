...
var getSubstringIndex = function getSubstringIndex(str, substr, ignoreAccents) {
  var display = ignoreAccents ? normalizeString(str) : str;
  var query = ignoreAccents ? normalizeString(substr) : substr;
  var regex = createMatcher(query);
  var match = display.match(regex);
